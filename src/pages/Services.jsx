...
const services = [
  {
    ...
    img: '/images/solar-panels-closeup.jpg',
  },
  {
    icon: <BatteryIcon />,
  ...
  },
  {
    ...
    img: '/images/commercial-solar-building.jpg',
  },
  {
    icon: <ShieldIcon />,
    ...
    img: '/images/solar-installer-working.jpg',
  },
  {
    icon: <SunIcon />,
    ...
    img: '/images/modern-house-solar.jpg',
  },
  {
    icon: <LeafIcon />,
    title: 'Solar Roofing',
              ...
              >
                <Card glow style={{
                  ...
                  <div style={{
                    ...
                    <img
                      src={img(service.img.replace('/images/', ''))}
                      alt={service.title}
